...
<body>
	<div class="container flux">
		...
		<div class="row">
			<div class="col-md-12">
				<h2 class="title mt-5 mb-5">Ajouter un service</h2>
				<div class="row">
					<div class="col-md-12">
						<form action="AddServices.php" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label for="services_type" class="col-sm-2 control-label mb-3">Type de service<span style="color:red">*</span></label>
							...
							<div class="form-group">
								<label for="services_details" class="col-sm-2 control-label mb-3">Services<span style="color:red">*</span></label>
								<div class="col-sm-4">
								...
								<div class="form-group">
									<div class="col-sm-8 col-sm-offset-2 mb-3">
										...
										<button class="btn btn-danger mt-3" name="submit_services_btn" type="submit">Ajouter le service</button>
									</div>
								</div>
						</form>
					</div>
