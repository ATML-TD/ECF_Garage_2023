                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $result) {                ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger my-3" href="DeleteCars.php?delete=<?php echo $result->id;?>" onclick="return confirm('Etes-vous certain de vouloir supprimer le véhicule?');">Supprimer</a>
                                </td>
                            </tr>
                    <?php $cnt = $cnt + 1;
                        }
